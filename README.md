...
## Web Application:
An interactive canvas was created when the the predict button is clicked the image data is sent as a json string and passed through a prediction algorithm. The predicted data/number is displayed at the bottom of the canvas. you can also see the prediction probability in your browser console.
...
- To **run web application**
 ...
 - [Intro to CNN's](https://medium.com/@RaghavPrabhu/understanding-of-convolutional-neural-network-cnn-deep-learning-99760835f148)
 - [http://cs231n.stanford.edu/](http://cs231n.stanford.edu/)
 - [Video tutorials on ComputerVision](https://www.youtube.com/watch?v=ArPaAX_PhIs&list=PLkDaE6sCZn6Gl29AoE31iwdVwSG-KnDzF&index=2&t=0s)
 - [Slides on ComputerVision](https://cs230.stanford.edu/files/C4M1.pdf)
