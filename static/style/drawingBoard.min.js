...
! function() {
    ...
    function() {
        ...
        initialize: function() {
            var a = "";
            if (this.opts.back && (a += '<button class="drawing-board-control-navigation-back">&larr;</button>'), this.opts.forward && (a += '<button class="drawing-board-control-navigation-forward">&rarr;</button>'), this.opts.reset && (a += '<button class="drawing-board-control-navigation-reset">&times; clear</button>'), this.$el.append(a), this.opts.back) {
            ...
            this.opts.reset && this.$el.on("click", ".drawing-board-control-navigation-reset", $.proxy(function(a) {
                this.board.reset({
                    background: !0
                }), $('#R').html("Prediction cleared"), a.preventDefault()
            }, this))
        },
    ...
    DrawingBoard.Control.Download = DrawingBoard.Control.extend({
        ...
        initialize:
            ...
            function() {
            this.$el.append, this.$el.on("click", ".drawing-board-control-download-button", $.proxy(function(a) {
